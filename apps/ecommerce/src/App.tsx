  ...
  return (
    <AdheseProvider options={{
      ...
      <div className="min-h-screen bg-white flex flex-col">
        {/* Announcement Bar */}
        <div className="bg-[#1a1a1a] text-white text-center py-2.5 text-sm">
          Free shipping on orders over $75. <a href="#" className="underline ml-1">Shop now</a>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#" className="text-sm hover:opacity-70 transition-opacity">Shop</a>
            <a href="#" className="text-sm hover:opacity-70 transition-opacity">Collections</a>
            <a href="#" className="text-sm hover:opacity-70 transition-opacity">About</a>
            <a href="#" className="text-sm hover:opacity-70 transition-opacity">Journal</a>
          </nav>
          ...
          <div className="flex items-center gap-5">
            ...
            <button className="hover:opacity-70 transition-opacity relative">
              ...
              <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-black text-white text-[10px] rounded-full flex items-center justify-center">2</span>
            </button>
          </div>
        </div>
      </div>
    ...
    <footer className="border-t border-gray-200 mt-20">
      <div className="max-w-[1400px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-wider mb-5">Newsletter</h4>
            <p className="text-sm text-gray-600 mb-4">Subscribe for updates and 10% off your first order.</p>
            <div className="flex">
              <input
                type="email"
                placeholder="Email"
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>© 2024 Nordic. Demo store for Adhese SDK.</p>
